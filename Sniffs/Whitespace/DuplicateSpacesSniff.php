...
/**
 * Checks that there are no double-spaces anywhere, except before @OA annotations.
 *
 * Based on SlevomatCodingStandard\Sniffs\Whitespaces\DuplicateSpacesSniff
 */
...
//			exit (json_encode($tokens[$pointerAfter]));
        ...
        foreach ($matches[0] as [$match, $offset]) {
            ...
            // Maagiline if condition.
            if (strpos($tokens[$whitespacePointer+1]['content'], '@OA') !== false) {
                return;
            }
